    ...
    render() {
        return (
            <div className="blog_area single-post-area section-padding">
              ...
              people like this (Load list user like post)</p>
                                    ...
                                    <div className="row">
                                        <div className="col-12">
                                            <div className="form-group">
                                                <textarea className="form-control w-100" name="comment" id="comment" cols={30} rows={9} placeholder="Viết bình luận..." defaultValue={""} />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="form-group">
